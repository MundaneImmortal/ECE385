...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/lab7_soc_mm_interconnect_0_avalon_st_adapter_005_error_adapter_0.sv" -work error_adapter_0                             
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/lab7_soc_mm_interconnect_0_avalon_st_adapter_005.v"                  -work avalon_st_adapter_005                       
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/lab7_soc_mm_interconnect_0_router_007.sv"                            -work router_007                                  
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/lab7_soc_keycode.v"                                                  -work keycode                                     
